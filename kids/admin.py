...
class salon_Admin(admin.ModelAdmin):
    list_display = ('kids_ph_salon_001',)


admin.site.register(kids_ph_salon)


class oyoc_Admin(admin.ModelAdmin):
    list_display = ('kids_ph_oyoc_001',)


admin.site.register(kids_ph_oyoc)


class pw_Admin(admin.ModelAdmin):
    list_display = ('kids_ph_pw_001',)


admin.site.register(kids_ph_pw)


class nb_Admin(admin.ModelAdmin):
    list_display = ('kids_ph_nb_001',)


admin.site.register(kids_ph_nb)
